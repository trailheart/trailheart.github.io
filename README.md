# Egehan ÇETİNEL — Developer Portfolio (`trailheart.github.io`)

Welcome to the official repository for my personal developer portfolio website: **[trailheart.github.io](https://trailheart.github.io)**.

I am **Egehan ÇETİNEL** (`@trailheart`), a high school student in Istanbul, Türkiye, studying **Electric-Electronics** with a deep interest in **Python**, **Linux Kernel Architecture**, and **Cyber Security**.
...
- **Obsidian Dark Surface**: Warm obsidian palette (`#111113`) with frosted glassmorphism blur and warm terracotta accents (`#da7756`).
...
- **Organizations**: [Vespera Industries](https://github.com/Vespera-Industries)
...
&copy; 2026 Egehan ÇETİNEL (trailheart) — Open source under the MIT License.
